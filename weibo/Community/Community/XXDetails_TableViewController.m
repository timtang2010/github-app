//
//  ZCDetails_TableViewController.m
//  Community
//
...
#import "XXSubClasses_TableViewController.h"

@interface XXDetails_TableViewController ()

@end

@implementation XXDetails_TableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqualToString:@"ShowSelected"]) {
        XXSubClasses_TableViewController *detailViewController = segue.destinationViewController;
        
        NSInteger selectedIndex = [[self.tableView indexPathForSelectedRow]row];
        NSDictionary *dict = [self.listData objectAtIndex:selectedIndex];
        
        NSString *qusetion = [dict objectForKey:@"qusetion"];
