...
//    return [tableView rowHeight];
    ...
    //最新修改框架功能
    if ([self.expandedIndexPaths[indexPath.section] containsObject:indexPath] && [_SKSTableViewDelegate respondsToSelector:@selector(heightForSubTable: subCellHeightAtIndexPath:)])
    {
        return [_SKSTableViewDelegate heightForSubTable:tableView subCellHeightAtIndexPath:indexPath];
    }
    else if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:heightForRowAtIndexPath:)])
    {
