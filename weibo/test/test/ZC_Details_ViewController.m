...
@interface ZC_Details_ViewController ()

@end

@implementation ZC_Details_ViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqualToString:@"ShowSelected"]) {
        ZC_Subclasses_TableViewController *detailViewController = segue.destinationViewController;
